...
// Plasmic Project: rXoqDLY76vFdZzABMEcmS
// Component: vO_RT_BPT1cq
...
import projectcss from "./plasmic.module.css"; // plasmic-import: rXoqDLY76vFdZzABMEcmS/projectcss
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: vO_RT_BPT1cq/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: VsCKlrmA2clK/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: BPWUYyM0JxUm/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__pHbpw)}
          role={"img"}
        />
      }
      navMenuItems={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__tj1Gc)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__luVYq)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox__uxarg)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__klExQ)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
